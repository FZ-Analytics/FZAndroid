...
//    public static final String databaselocation = "/storage/emulated/0";
    ...
    public boolean SaveTrackingData(HashMap<String, String> TrackingData) {
        ...
        if (OpenDatabase()) {
            ...
            values.put("Status", TrackingData.get("Status"));
...
//    }
    ...
    public boolean UpdateSyncTaskList(HashMap<String, String> SyncTrxData) {
        ...
        if (OpenDatabase()) {
            ...
            values.put("LocationID", SyncTrxData.get("LocationID"));
            values.put("Status", SyncTrxData.get("Status"));
            NewPos = sqlDatabase.update(LocationTable, values, "LocationID=" + Integer.valueOf(SyncTrxData.get("LocationID")), null);
